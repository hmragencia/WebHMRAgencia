    ...
    <section id="inicio" className="relative h-screen flex items-center justify-center text-center text-white" style={{ backgroundImage: `url(${heroBgUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      >
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight">
          Transformamos Ideas en <br className="hidden sm:block" />
          <span style={{ color: '#FFEB3B' }} className="text-hmr-yellow drop-shadow-lg">Experiencias Inolvidables</span>
        </h1>
        <p className="text-lg sm:text-xl md:text-2xl mb-10 max-w-3xl mx-auto font-light">
          En HMR Agencia, combinamos creatividad, estrategia y tecnología para impulsar tu presente.
        </p>
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
          ...
          >
            <span className="text-gradient-blue font-semibold">Hablemos de tu Proyecto</span>
          </Button>
        </div>
      </motion.div>
    </section>
